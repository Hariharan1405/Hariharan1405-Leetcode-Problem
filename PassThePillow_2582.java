 ...
 * next person standing in the line. Once the pillow reaches the end of the line, 
 * the direction changes, and people continue passing the pillow 
...
class  PassThePillow_2582{
    public int passThePillow(int n, int time) {
        int completionRound = time/(n-1);
        int partialRoundLeft = time%(n-1);
        if(completionRound%2==0){
            return partialRoundLeft + 1;
        }
        else{
            return n-partialRoundLeft;
        }
    }
}
